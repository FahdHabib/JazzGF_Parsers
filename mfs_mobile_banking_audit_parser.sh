...
echo "Call mfs mobile banking audit Parser"
...
echo $5
echo $fileName
echo $originlaFileName


#Inserted below cmd on 26th July 2022 - For removal of special character
sed 's/�//g' "$fileName" > $1/MBA_PARSER_Output.csv

#mv $2/MBA_PARSER_Output.csv $1/$originlaFileName

python3 mfs_preprocessor_mobile_banking.py "*PARSER**.csv" "$1" "$2"

mv $2/MBA_PARSER_Output.csv $2/$originlaFileName
